...
const Notification = ({ message, history, runner, isFriend=false, openFunction, setNotificationView, notificationView, deleteFunction, socket }: any) => {
